...
import com.company.CompanyApp.exception.notFound.*;
import com.company.CompanyApp.model.ApiError;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(value = {ConstructionNotFoundException.class, MaterialNotFoundException.class, UsernameNotFoundException.class,
            CustomerNotFoundException.class, AdminNotFoundException.class, TaskNotFoundException.class, UserNotFoundException.class})
